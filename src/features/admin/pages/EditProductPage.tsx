...
import { AdminModuleBar, AdminBody, AdminConfirmDialog } from '../components/AdminUI';
        ...
        <AdminBody>
          <div className="adm-card">
            <div className="adm-card-body">
              ...
              <button type="button" className="adm-btn primary" style={{ marginTop: 12 }} onClick={() => navigate('/admin/edit-products')}>
                ← Back to products
              </button>
            </div>
          </div>
    ...
    <>
      ...
      <AdminBody>
        <ProductForm
          ...
          onCancel={() => navigate('/admin/edit-products')}
      ...
      {confirmingDelete && (
        <AdminConfirmDialog
          ...
          message={`Archive "${product.name}" (${product.sku})? It will be removed from the customer catalog.`}
