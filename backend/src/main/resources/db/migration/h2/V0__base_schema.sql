...
-- ============================================================
-- RETURNS (Must come BEFORE REFUNDS)
-- ============================================================
...
-- ============================================================
-- REFUNDS (Must come AFTER RETURNS for FK dependency)
-- ============================================================
...
-- Insert admin role
INSERT INTO admin_roles (id, name, description, is_active, created_at) 
VALUES (1, 'SUPER_ADMIN', 'Full system access', 1, CURRENT_TIMESTAMP());

-- Insert all admin permissions (19 permissions for full RBAC)
INSERT INTO admin_permissions (id, permission_key, module, description) VALUES
...
-- Username: testadmin / Password: password123 (bcrypted)
-- Password hash: $2a$10$slYQmyNdGzin7olVN3p5H.bXO6Y8DV9rZ5A0vBvqwB9VJLXwqXAYi
INSERT INTO admin_users (username, password_hash, email, full_name, role_id, is_active, created_at, updated_at) 
VALUES 
('testadmin', '$2a$10$slYQmyNdGzin7olVN3p5H.bXO6Y8DV9rZ5A0vBvqwB9VJLXwqXAYi', 'admin@test.local', 'Test Admin', 1, 1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
('owner', '$2a$10$slYQmyNdGzin7olVN3p5H.bXO6Y8DV9rZ5A0vBvqwB9VJLXwqXAYi', 'owner@test.local', 'Owner Admin', 1, 1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
