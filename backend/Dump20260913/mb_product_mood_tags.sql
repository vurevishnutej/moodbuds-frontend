...
--
-- Table structure for table `product_mood_tags`
--

DROP TABLE IF EXISTS `product_mood_tags`;
...
--
-- Dumping data for table `product_mood_tags`
--

LOCK TABLES `product_mood_tags` WRITE;
/*!40000 ALTER TABLE `product_mood_tags` DISABLE KEYS */;
/*!40000 ALTER TABLE `product_mood_tags` ENABLE KEYS */;
UNLOCK TABLES;
