...
CREATE TABLE `product_sizes` (
  ...
  `low_stock_threshold` int unsigned NOT NULL DEFAULT '5' COMMENT 'Alert admin when stock falls below this',
  `is_available` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'Can be disabled without deleting',
