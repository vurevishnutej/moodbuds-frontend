...
CREATE TABLE `size_charts` (
  ...
  `subcategory_id` int unsigned DEFAULT NULL COMMENT 'NULL = global default chart',
  `product_id` bigint unsigned DEFAULT NULL COMMENT 'Product-specific override if set',
  `chart_image_url` varchar(500) DEFAULT NULL COMMENT 'Uploaded image version of chart',
