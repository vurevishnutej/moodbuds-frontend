...
CREATE TABLE `inventory_logs` (
  ...
  `quantity_change` int NOT NULL COMMENT 'Negative for reduction, positive for addition',
  `quantity_before` int unsigned NOT NULL,
  `quantity_after` int unsigned NOT NULL,
  `reference_type` varchar(50) DEFAULT NULL COMMENT 'order, return_request',
  `created_by` int unsigned DEFAULT NULL COMMENT 'admin_users.id; NULL = system-generated',
