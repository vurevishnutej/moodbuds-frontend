...
CREATE TABLE `coupon_usage` (
  ...
  `order_id` bigint unsigned DEFAULT NULL COMMENT 'Populated when order is confirmed',
  `discount_applied` int unsigned NOT NULL COMMENT 'Actual discount amount in paise',
